...
const ActivityContents: ActivityCardProps[] = [
    {
        ...
        backgroundImage:
            "https://images.unsplash.com/photo-1585856141833-ca095e957dd3?q=80&w=3432&auto=format&fit=crop",
    },
    {
        title: "스터디",
        description: "파트별 스터디를 통해 서로의 지식을 나누고 배우며 함께 성장해요.",
        backgroundImage:
            "https://images.unsplash.com/photo-1589810850957-e41f2fe9d9cb?q=80&w=3544&auto=format&fit=crop",
    },
    {
        title: "실전 프로젝트",
        description: "다른 파트 회원들과 함께하는 팀 프로젝트를 통해 실전 경험을 쌓아요.",
        backgroundImage:
            "https://images.unsplash.com/photo-1566938462541-756285176500?q=80&w=3538&auto=format&fit=crop",
    },
    {
        title: "연합 프로젝트",
        description:
        ...
        backgroundImage:
            "https://images.unsplash.com/photo-1726687610942-2dd2616ec357?q=80&w=3542&auto=format&fit=crop",
    },
];
